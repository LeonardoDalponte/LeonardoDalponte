...
<strong> * Sou Leonardo Dalponte, um jovem desenvolvedor apaixonado por aprender e enfrentar desafios complexos através da programação. Tenho estudos em Kotlin e desenvolvimento android, Além de Java ultilizando Spring Framework, e vejo cada novo projeto como uma oportunidade para expandir minhas habilidades e conhecimentos. Atualmente estou estagiando como desenvolvedor, e aprendendo e ultilizando node, typescript com o framework nest.js, Estou sempre aberto a novas oportunidades ou desafios e vejo eles como uma forma de me tornar um bom desenvolvedor melhor. </strong>
